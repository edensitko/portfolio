...
import ProfileImg from "../assets/images/eden2.png";
...
import JessicaMainImg from "../assets/images/eden.png";
...
import $ from "jquery";
import CV from "../assets/pdf/EdenSitkovetsky.pdf";
      ...
      <div className="side-menu">
        <div className="profile-img-main">
          ...
          <div className="profile-media-icons-main fade_up">
            <Link to="mailto:edensit139@gmail.com" className="profile-media-icons">
              <img src={EmailSvg} alt="email-svg" />
            </Link>
           
            <Link to="https://www.linkedin.com/in/eden-sitkovetsky-0b1b3b1b9/" className="profile-media-icons">
        ...
        <section className="section-one overflow-hidden" id="home">
          <div className="row">
            ...
            <div className="col-xxl-6 col-lg-6 position-relative">
              ...
              />
              <div className="worked-box worked-more">
              <p className="worked-more">inspired by
                
                 <Typewriter  className = "worked-more"

words={[' challenges',' oppotunities',
  ' innovations',' creativity',' successes']}
